...
const CURRENTLEVEL = {
  ...
  system: {
    ...
    draw_fog: function() {
      ...
      CURRENTLEVEL.system.move_fog(0,0);
    },

    move_fog: function(x, y){
      var h = SCREEN.height();
      var w = SCREEN.width();
      var viewport_w = 500;
      var viewport_h = 500;

      var top_border = Math.ceil((h - viewport_h) / 2);
      var side_border = Math.ceil((w - viewport_w) / 2);
