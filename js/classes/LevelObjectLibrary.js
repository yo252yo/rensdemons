...
class S_Floor extends LevelObject {
  constructor(x, y, w, h) {
    var visual = new Rectangle(x,y,w,h, PALETTE.color('background').code());
    super(visual, x, y);
...
class S_Tree extends LevelObject {
  constructor(x, y) {
    var visual = new StaticSprite("assets/tree.png", PALETTE.color('obj_light').code());
    super(visual, x, y);
...
class S_House extends LevelObject {
  constructor(x, y) {
    var visual = new StaticSprite("testing/house.png", PALETTE.color('obj_dark').code());
    super(visual, x, y);
...
class S_SavePoint extends LevelObject {
  constructor(x, y) {
    var visual = new StaticSprite("assets/savepoint.png", PALETTE.color('obj_dark').code());
    super(visual, x, y);
  ...
  interaction() {
    new TextMenu("You found an Altar of the Goddess. Will you pray that She remembers you?",
                  [
                    {"text": "Worship", "effect": function(){ return SAVE.print_save_menu(); }},
                    {"text": "DEBUG#LOAD", "effect": function(){ return SAVE.print_load_menu(); }},
