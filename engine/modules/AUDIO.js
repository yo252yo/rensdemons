...
const AUDIO = {
  ...
  init: function (){
    ...
    AUDIO._load_music('level/frozen jungle');
    AUDIO._load_music('level/glouglou');
    AUDIO._load_music('level/igot99broadswords');
    AUDIO._load_music('level/ihatehimsomuch');
    AUDIO._load_music('level/itsnevertoolateforsidequests');
    AUDIO._load_music('level/jeudelaconversation');
    AUDIO._load_music('level/la pire nausee n\'est pas ici');
    AUDIO._load_music('level/sensual melancholia');
    AUDIO._load_music('level/top me');
    AUDIO._load_music('level/twoarmiesfightinginadystopianformicapunkworld');
    AUDIO._load_music('level/whatgreyaliensaredoingtothecows');
    AUDIO._load_music('level/whatifyouaretheevildoppleganger');
    AUDIO._load_music('level/whenyouareallovermybody');
