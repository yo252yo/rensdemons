...
houseFiller.set_object(120, 160, function(x,y,g){ return new S_House(CITIES.fear, x, y, g.get()); });
...
villagerFiller.set_object(50, 60, function(x,y,g){ return new M_Villager(CITIES.fear, x, y, g.get()); });
