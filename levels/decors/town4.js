...
new S_Store("Weapon", 500, 100, 1000, gen.get());
new S_Store("Alchemy", 10000, 1825, 900, gen.get());


var houseFiller = new Filler(gen);
houseFiller.set_zone(75, 1025, 1950, 950);
houseFiller.set_tries(5, 60);
houseFiller.set_object(120, 160, function(x,y,g){ return new S_House(CITIES.debauch, x, y, g); });
...
villagerFiller.set_object(50, 60, function(x,y,g){ return new M_Villager(CITIES.debauch, x, y, g); });
