...
CURRENTLEVEL.start_function = function() {
  TextBannerSequence.make([
    ...
    `The passerbys are chatting loudly, laughing, dancing... Everywhere you turn, you see happy faces. You can hear music coming out of different houses, sometimes dulled down by the walls, other times straight through open doors and windows, resulting in a complete cacophony. Smells are spreading too, and your stomach is excited by the aronmas of delicious meals or fruity drinks that surround you.`,
    ...
    `The stranger gives you cups of a bevrage whose strong scent betrayed a powerful intoxicating content.`,
