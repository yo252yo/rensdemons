...
parchment_canvas.style.width = "500px";
parchment_canvas.style.height = "666px";
parchment_canvas.style.left = "300px";
parchment_canvas.style.top = "300px";
...
RESOURCES.onload(resource, function() {
  parchment_canvas.getContext('2d').drawImage(resource, 0, 0,500,666);
///  setTimeout(function(){
...
function drawmap(){
   ...
   map1_canvas.style.top = "30%";
   map1_canvas.style.width = "1000px";
   map1_canvas.style.height = "1000px";
   map1_canvas.style.marginLeft = "-500px";
   ...
   //  },10000);
     ...
     map2_canvas.style.top = "30%";
     map2_canvas.style.width = "1000px";
     map2_canvas.style.height = "1000px";
     map2_canvas.style.marginLeft = "-500px";
     ...
     RESOURCES.onload(map2, function() {
        var offset1 = Math.floor(Math.random() * 4500);
         ...
         map2_canvas.getContext('2d').drawImage(map1, 0, 0,1000,1000);
