  ...
  constructor(x, y){
    ...
    var secretEnd = function(){
      ...
      TextBannerSequence.make([
        ...
        `$$Ren$: "What?"`,
        `$$demon_lord$: "` + GLITCH.glitch_text(`Maybe it's not too late! Kill me! Please! Kill me! Maybe we can still fix it!`, 0.01) + `"`,
        `$$demon_lord$ ` + GLITCH.glitch_text(`pitifully grabs your arm and shakes your weapon, but you're still too puzzled to do anything. The colossal demon starts sobbing like a newborn.`, 0.01),
        `$$demon_lord$: "` + GLITCH.glitch_text(`Please! I don't want to imagine what She will do to me! I've failed her! I was supposed to punish the humans for their hubris, and die peacefully when my time comes!`, 0.02) + `"`,
        `$$Ren$: "You mean... The Goddess is behind the demon invasion?"`,
        `$$demon_lord$: "` + GLITCH.glitch_text(`How could She not be? She is Divine! Everything is Her Holy Will! I just obey Her commands! Oh, Goddess, forgive me! Forgive him! Please, just let me die!`, 0.03) + `"`,
        GLITCH.glitch_text(`Sobs turn into convulsions. It truly is a pathetic sight. Strident wails raise from the contorted muscular body.`, 0.04),
        `$$Ren$: "Focus! There may still be hope! I want to meet Her. Where is She?"`,
        `$$demon_lord$: "` + GLITCH.glitch_text(`Heaven! She's in Heaven, of course. She's always been near, but you couldn't see Her. It's pointless, though, you cannot survive Her wrath. We're doomed. This world has no point anymore, this life has no meaning. Please, oh, Mighty One, please spare little miserable me!`, 0.06) + `"`,
        `$$demon_lord$ ` + GLITCH.glitch_text(`lets out a high pitched scream that pierces your ears. The whimper continues.`, 0.1),
        `$$demon_lord$: "` + GLITCH.glitch_text(`She's here! She sees All! She's Everywhere! And She's angry at us! Oh please, please! Her reckoning has come! Please, let it stop! Kill me!`, 0.15) + `"`,
