  ...
  constructor(x, y){
    ...
    var secretEnd = function(){
      ...
      TextBannerSequence.make([
        ...
        `$$Ren$: "What?"`,
        `$$demon_lord$: "` + GLITCH.text.glitch(`Maybe it's not too late! Kill me! Please! Kill me! Maybe we can still fix it!`, 0.01) + `"`,
        `$$demon_lord$ ` + GLITCH.text.glitch(`pitifully grabs your arm and shakes your weapon, but you're still too puzzled to do anything. The colossal demon starts sobbing like a newborn.`, 0.01),
        `$$demon_lord$: "` + GLITCH.text.glitch(`Please! I don't want to imagine what She will do to me! I've failed her! I was supposed to punish the humans for their hubris, and die peacefully when my time comes!`, 0.02) + `"`,
